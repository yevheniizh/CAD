...
/* Nav panel */
export const wireframeButton = document.querySelector(".button.view-wireframe");
export const colorPickerButton = document.querySelector(".colorpicker .color-input");
